        ...
        base.methods = {
            ...
            answerQuestion: function(answerEl) {
                ...
                var $answerEl = $(answerEl),
                    ...
                    questionId = $answerEl.data('id'),
                    answerId = $answerEl.data('answerId'),
                ...
                if (typeof base.options.answerCallback === 'function') {
                    base.options.answerCallback(currentQuestion, selected, questions[currentQuestionIndex], options = {
                        questionId: questionId,
                        answerId: answerId,
                    });
                }
            ...
            finish: function() {
                ...
                if (typeof base.options.finishCallback === 'function') {
                    base.options.finishCallback(score, numQuestions);
                }
            },
            restart: function() {
                base.methods.reset();
