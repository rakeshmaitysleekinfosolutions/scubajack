        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-sm-5"><a href="<?php echo $parent;?>" data-toggle="tooltip" title="Parent" id="button-parent" class="btn btn-default"><i class="fa fa-level-up"></i></a> <a href="<?php echo $refresh;?>" data-toggle="tooltip" title="Refresh" id="button-refresh" class="btn btn-default"><i class="fa fa-refresh"></i></a>
                    ...
                    <button type="button" data-toggle="tooltip" title="Delete" id="button-delete" class="btn btn-danger"><i class="fas fa-trash-alt"></i></button>
                </div>
                <!--        <div class="col-sm-7">-->
...
<script>
    ...
    myLabel.filemanagerUpload   = '<?php echo site_url('filemanager/upload');?>';
    myLabel.filemanagerFolder   = '<?php echo site_url('filemanager/folder');?>';
    myLabel.filemanagerDelete   = '<?php echo site_url('filemanager/delete');?>';
</script>