<aside class="main-sidebar fixed offcanvas shadow">
    <section class="sidebar">
        <div class="w-80px mt-3 mb-3 ml-3">
            ...
            <img src="<?php echo base_url('assets/img/icon/daveyboy12 b.png'); ?>" alt="">
        </div>
        <div class="relative">
            ...
            <div class="user-panel p-3 light mb-2">
                <div>
                    ...
                    <div class="float-left info">
                        <h6 class="font-weight-light mt-2 mb-1">SILK PORTAL</h6>
                ...
                <div class="collapse multi-collapse" id="userSettingsCollapse">
                    <div class="list-group mt-3 shadow">
                        ...
                        ?>
                        <a href="<?php echo base_url('edit-profile').'/'.$id;  ?>" class="list-group-item list-group-item-action ">
                            <i class="mr-2 icon-umbrella text-blue"></i>Edit Profile
                        </a>
                        <a href="#" class="list-group-item list-group-item-action"><i
                                class="mr-2 icon-cogs text-yellow"></i>Settings</a>
                        <a href="<?= base_url('change-password');?>" class="list-group-item list-group-item-action"><i
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview"><a href="#"><i class="icon icon-bars light-green-text s-18"></i>User Managment<i
                    class="icon icon-angle-left s-18 pull-right"></i></a>
                <ul class="treeview-menu">
                    <li><a href="<?php echo base_url('users-list'); ?>"><i class="icon icon-circle-o"></i>All Users</a>
                    </li>
                    <!-- <li><a href="<?php echo base_url('add-category'); ?>"><i class="icon icon-add"></i>Add Category</a>
                    </li> -->
                </ul>
            </li>
