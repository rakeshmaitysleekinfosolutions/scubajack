        ...
        <div class="container-fluid text-white">
            ...
            <div class="row justify-content-between">
                <ul class="nav nav-material nav-material-white responsive-tab" id="v-pills-tab" role="tablist">
                    ...
                    <li>
                        <a class="nav-link active"  href="#" ><i class="icon icon-plus-circle"></i> Update Profile</a>
                    </li>
                </ul>
            </div>
        </div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-8">
                                        <div class="form-group m-0">
                                            ...
                                            <input name="admin_name" id="admin_name" placeholder="Enter Name" class="form-control r-0 light s-12 " type="text" value="<?php  echo $profile[0]['admin_name'];?>">
                                        </div>  
                                    </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group m-0">
                                            ...
                                            <input name="admin_user_name" id="admin_user_name" placeholder="Enter User Name" class="form-control r-0 light s-12 " type="text" value="<?php  echo $profile[0]['admin_user_name'];?>">
                                        </div>  
                                    </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group m-0">
                                            ...
                                            <input name="admin_email" id="admin_email" placeholder="Enter Email Id" class="form-control r-0 light s-12 " type="text" value="<?php  echo $profile[0]['admin_email'];?>">
                                        </div>  
                                    </div>
