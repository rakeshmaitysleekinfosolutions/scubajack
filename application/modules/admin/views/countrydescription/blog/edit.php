<div class="content container-fluid">
    <form id="frm" action="<?php echo $updateBlogUrl;?>" method="post">
        <div class="row">
                ...
                <div class="card-box">
                    ...
                    <div class="experience-box">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="smallDescription" minlength="50" maxlength="200" rows="4" cols="5" class="form-control" placeholder="" required><?php echo $smallDescription;?></textarea>
                        </div>
                        <div class="form-group">
