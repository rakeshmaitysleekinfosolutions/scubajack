<div class="content container-fluid">
    <div class="row">
        ...
        <div class="col-sm-8 col-xs-9 text-right m-b-20">
            ...
            <a href="<?php echo admin_url('answer/create');?>" class="btn btn-primary rounded pull-right"><i class="fa fa-plus"></i> Add</a>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
...
<script>
    ...
    myLabel.index       = '<?php echo admin_url('answer/onLoadDatatableEventHandler');?>';
