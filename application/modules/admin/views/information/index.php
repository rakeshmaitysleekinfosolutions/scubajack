...
<script>
    ...
    myLabel.index       = '<?php echo admin_url('information/onLoadDatatableEventHandler');?>';
    myLabel.status   = '<?php echo admin_url('information/onChangeStatusEventHandler');?>';
    myLabel.delete      = '<?php echo admin_url('information/delete');?>';
    myLabel.edit        = '<?php echo admin_url('information/edit/');?>';
</script>