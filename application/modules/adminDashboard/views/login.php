            ...
            <div class="row">
                ...
                <div class="col-lg-6 p-t-100">
                    <div class="text-white">
                        ...
                        <?php } ?>
                        <h1>Welcome Back SLIK-PORTAL</h1>
                        <p class="s-18 p-t-b-20 font-weight-lighter">Hi SILK_PORTAL welcome back!! Signin now</p>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group has-icon"><i class="icon-envelope-o"></i>
                                    <input type="text" class="form-control form-control-lg no-b" placeholder="Email Address" name="admin_email">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group has-icon"><i class="icon-user-secret"></i>
                                    <input type="password" class="form-control form-control-lg no-b" placeholder="Password" name="admin_password"> 
                                </div>
                            </div>
                            <div class="col-lg-12">
